export default function HeaderSection() {
    return (
      <section className="min-h-screen flex flex-col md:flex-row items-center justify-between px-8 md:px-20 py-16 bg-white">
        {/* Left Section */}
        ...
        <div className="md:w-1/2 mt-10 md:mt-0 flex justify-end">
          <div className="bg-white rounded-3xl shadow-md p-8 w-full max-w-sm border">
